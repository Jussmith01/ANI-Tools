...
tsparams = {'T':150, # trajectories to run
             'n_samples' : 25,
             'n_steps': 10,
             'steps': 1500,
             'min_steps': 100,
             ...
             'normalmode':0,                                 #id of normal mode - BROKEN
             'displacement':0.4,                               #Move the molecules initial coordiantes along the mode by this amount. Negative numbers are ok. BROKEN
             }
