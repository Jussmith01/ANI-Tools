...
wkdir   = '/home/jsmith48/scratch/auto_al/modelCNOSFCl/ANI-AL-0808/ANI-AL-0808.0303/'
iptfile = '/home/jsmith48/scratch/auto_al/modelCNOSFCl/inputtrain.ipt'
saefile = '/home/jsmith48/scratch/auto_al/modelCNOSFCl/sae_linfit.dat'
cstfile = '/home/jsmith48/scratch/auto_al/modelCNOSFCl/rHCNOSFCl-5.0R_16-3.4A_a4-8.params'
...
for i in N:
    ...
    netdir = wkdir + 'ANI-AL-0808.0303.04' + str(i).zfill(2) + '/'
    ...
    ast.generateQMdata(hostname, username, swkdir, ldtdir, datdir + str(i+1).zfill(2), h5stor, mae, jtime,max_jobs=250)
