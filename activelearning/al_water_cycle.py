...
wkdir = '/home/jsmith48/scratch/auto_wat_al/modelwat/ANI-1x-WAT-0013/'
iptfile = '/home/jsmith48/scratch/auto_wat_al/modelwat/inputtrain.ipt'
saefile = '/home/jsmith48/scratch/auto_wat_al/modelwat/sae_linfit.dat'
cstfile = '/home/jsmith48/scratch/auto_wat_al/modelwat/rHO-5.8R_32-4.5A_a4-8.params'
...
gcmddict = {'edgepad': 0.7, # padding on the box edge
            'mindist': 1.3, # Minimum allow intermolecular distance
            'sig' : M, # sig hat for data selection
            'maxsig' : 50.0*M, # Max frag sig allowed to continue dynamics
            'Nr': 32, # Number of boxed to run
            'MolHigh': 1700, #High number of molecules
            'MolLow': 1147, #Low number of molecules
            'Ni': 2500, #steps before checking frags
            'Ns': 5,
            'dt': 0.4,
            'V': 0.03,
            'L': 35.0,
...
for i in N:
    ...
    netdir = wkdir + 'ANI-1x-WAT-0013.00' + str(i).zfill(2) + '/'
    print(netdir)
