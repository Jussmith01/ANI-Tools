...
#--------------------------------
#File name
pf = '/home/jsmith48/scratch/ccsd_extrapolation/ccsd_new/ccsd_train_new6/rHCNO-3.8A_16-2.6A_a4-8.params' # Output filename
...
TM = 1
Rcr = 3.8 # radial cutoff
Rca = 2.6 # Angular cutoff
